...
namespace ConsoleDraw.Inputs
{
    public class CheckBox : Input
    {
        ...
        public CheckBox(int x, int y, String iD, Window parentWindow) : base(x, y, 1, 3, iD, parentWindow)
        {
        ...
        {
            windows.MovetoNextItemDown(Xpostion + 1, Ypostion, Width);
        }

        public override void CursorMoveRight()
        {
            windows.MovetoNextItemRight(Xpostion - 1, Ypostion + Width, 3);

        }

        public override void CursorMoveLeft()
        {
            windows.MovetoNextItemLeft(Xpostion - 1, Ypostion, 3);
        }

        public override void CursorMoveUp()
        {
            windows.MovetoNextItemUp(Xpostion - 1, Ypostion, Width);
        }
    }
}
