namespace IvyOS.HAL.KeyBoard.Layout
{
    ...
    /// </summary>
    public class QWERTZ : KeyLayoutBase
    {
        protected override void InitKeys()
        {
            ...
            AddKey(21u, 'z', ConsoleKeyEx.Z);
            AddKey(1376256u, 'Z', ConsoleKeyEx.Z);
            ...
            // Y X C V B N M
            AddKey(44u, 'y', ConsoleKeyEx.Y);
            AddKey(2883584u, 'Y', ConsoleKeyEx.Y);
            ...
            AddKey(2686976u, '\0', ConsoleKeyEx.NoName);
            ...
            AddKey(524288u, '/', ConsoleKeyEx.NumDivide);
